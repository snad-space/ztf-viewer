...
- A shared link previews as a card: an object page with its light curve, any other page with the SNAD logo https://github.com/snad-space/ztf-viewer/issues/98
