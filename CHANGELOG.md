...
- A shared link previews as a card: an object page with its light curve and SNAD name, any other page with the site's own https://github.com/snad-space/ztf-viewer/issues/98
